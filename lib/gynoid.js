...
Gynoid.prototype.registerDroid = function(name, token) {
  ...
  return new Promise(function (resolve, reject) {
    if (register.droids[name]) {
      return reject({error: 'droid_registered', message: 'Droid ' + name + ' is already registered. Please, remove it first.'});
    }
  ...
  return new Promise(function(resolve, reject) {
    ...
    return register.extensions.isValidExtension(droid, extension)
      .then(function() {
        ...
        return register.installer.installDependencies(extension, spec);
      }).then(function() {
