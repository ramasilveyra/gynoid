  ...
  return new Promise(function(resolve, reject) {
    ...
    spec.actions.forEach(function(action) {
      ...
      action.aliases.forEach(function(alias) {
        ...
        var listener = droid.listener.listen(alias, core[action.function]);
...
DroidMatrix.prototype.startDroid = function(specPath, callback) {
...
//     .then(function() {
//       matrix.startDroid(__dirname + '/../' + droidName, function() {
